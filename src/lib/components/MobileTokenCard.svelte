...
<div
	...
	class="relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden select-none {selected
...
>
	...
	{#if showQuickActions}
		...
		<div
			class="absolute inset-y-0 right-0 w-20 bg-yellow-500 flex items-center justify-center transition-opacity duration-200 {swipeDirection ===
			'left'
				? 'opacity-100'
				: 'opacity-0'}"
		>
		...
		<div
			class="absolute inset-y-0 left-0 w-20 bg-blue-500 flex items-center justify-center transition-opacity duration-200 {swipeDirection ===
			'right'
				? 'opacity-100'
				: 'opacity-0'}"
		>
	...
	<div class="relative z-10 bg-white dark:bg-gray-800">
		...
		<div class="flex items-center justify-between mb-3">
			<div class="flex items-center gap-3 flex-1 min-w-0">
				...
				<div class="flex-1 min-w-0">
					<div class="flex items-center gap-2">
						...
						<Badge
							class="text-xs px-2 py-1 {token.type === 'VOI'
			...
			<button
				type="button"
				class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors {favorited
		...
		{#if !compact}
			<!-- Activity indicators -->
			<div
				class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-600"
			>
		...
		<div class="flex items-center gap-3">
			...
			<div class="flex-1">
				...
				<div class="text-xs opacity-80">
					Tap to select • Swipe left to favorite • Swipe right to compare • Long press for more
				</div>
			</div>
