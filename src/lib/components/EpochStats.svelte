<script lang="ts">
	...
	onMount(() => {
		...
		const fetchData = async () => {
			try {
				const [epochsResponse, marketsResponse, priceHistoryResponse, onlineAccountsResponse] =
					await Promise.all([
						fetch('/api/epochs'),
			...
			tooltip: {
				...
				formatter: (params: any) => {
					...
					const communityStake =
						params.find((p: any) => p.seriesName === 'Community Stake')?.value || 0;
					const ballastStake =
						params.find((p: any) => p.seriesName === 'Ballast and BA Stake')?.value || 0;
	...
	{:else}
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
					...
					<div class="grid grid-cols-2 gap-4">
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								...
								<div
									class="invisible group-hover:visible absolute z-10 w-64 bg-white dark:bg-gray-800 text-sm text-gray-500 dark:text-gray-400 rounded-lg shadow-lg p-3 right-0 mt-2 border border-gray-200 dark:border-gray-700"
								>
							...
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								...
								{#if priceChange24h}
									<span
										class="text-sm ml-2 {priceChange24h >= 0 ? 'text-green-500' : 'text-red-500'}"
									>
						...
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								<button
									aria-label="Current Block Reward APR"
									class="flex items-center justify-center w-6 h-6 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
							...
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								{formatNumber(latest.apr, 2)}%
							</p>
						</div>
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								<button
									aria-label="Current Epoch Reward"
									class="flex items-center justify-center w-6 h-6 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
							...
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								{formatNumber(latest.reward)} VOI
							</p>
						</div>
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								<button
									aria-label="Current Online Stake"
									class="flex items-center justify-center w-6 h-6 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
							...
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								{formatNumber(latest.online_stake / 1_000_000)}M
							</p>
						</div>
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								<button
									aria-label="Current Eligible Stake"
									class="flex items-center justify-center w-6 h-6 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
								...
								<div
									class="invisible group-hover:visible absolute z-10 w-64 bg-white dark:bg-gray-800 text-sm text-gray-500 dark:text-gray-400 rounded-lg shadow-lg p-3 right-0 mt-2 border border-gray-200 dark:border-gray-700"
								>
									Amount of online stake eligible for rewards (excludes ballast and caps Block
									Authority stake)
								</div>
							</div>
							<p class="text-sm text-gray-500 dark:text-gray-400">Eligible Stake</p>
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								{formatNumber(latest.eligible_online_stake / 1_000_000)}M
							</p>
						</div>
						<div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg relative">
							<div class="group absolute top-2 right-2">
								<button
									aria-label="Current Participating Accounts"
									class="flex items-center justify-center w-6 h-6 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
							...
							<p class="text-2xl font-bold text-gray-900 dark:text-white">
								{onlineAccountCount !== null ? formatNumber(onlineAccountCount) : '---'}
							</p>
						</div>
					</div>
				{/if}
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:col-span-2">
				<h2 class="text-2xl font-bold mb-4 text-gray-900 dark:text-white">
					Stake Distribution (Millions VOI)
				</h2>
