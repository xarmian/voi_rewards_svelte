...
<div
	class="relative cursor-pointer transform hover:scale-110 transition-transform duration-200"
	on:click={() => displayCollection(collection)}
>
	{#if tokens && tokens.length >= 1}
		<div class={styleClass}>
			<div
				class="flex justify-center -space-x-36 group-hover:-space-x-48 transition-all duration-500"
			>
