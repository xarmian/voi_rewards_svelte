	...
	function shareToSocialMedia(platform: string) {
		...
		switch (platform) {
			...
			case 'instagram':
				...
				toast.push(
					'Content copied to clipboard. You can now paste it into your Instagram story or post.'
				);
				popoverOpen = false;
				return;
		}
...
<Popover class="w-64 text-sm font-light relative z-10" bind:open={popoverOpen} {placement}>
	<div class="px-3 py-2">
