<script lang="ts">
	...
	async function handleOptInOut(value: boolean) {
		...
		if (!response.ok) {
			...
			toast.push('Notification preferences updated successfully', {
...
<div class="max-w-4xl mx-auto p-4 space-y-6">
	...
	<div class="border-b border-gray-200 dark:border-gray-700 pb-4">
		...
		<p class="mt-2 text-gray-600 dark:text-gray-400">
			Manage how and when you want to receive notifications about your Voi accounts and activities.
		</p>
	</div>
				...
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-xs text-gray-500 dark:text-gray-400">
							Receive a daily summary of your earned rewards
						</p>
					</div>
			...
			<div class="space-y-4">
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-xs text-gray-500 dark:text-gray-400">
							Get notified when new proposals are available
						</p>
					</div>
					<div class="flex items-center gap-4">
						<button
		...
		<div class="space-y-4">
			{#if primaryAccountInfo}
				<div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
					...
					<span
						class="px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-300"
					>
						Primary
					</span>
				</div>
