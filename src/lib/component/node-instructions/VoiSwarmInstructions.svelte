...
<div class="space-y-6">
	...
	<div class="space-y-3">
		...
		<p class="text-gray-600 dark:text-gray-400">Generate a participation key for your account.</p>
		<div
	...
	<div class="space-y-3">
		<h3 class="text-lg font-medium text-gray-900 dark:text-white">
			2. View Participation Key Details
		</h3>
		<p class="text-gray-600 dark:text-gray-400">View the details of your participation key.</p>
		<div
			class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700"
		>
			<div class="flex items-center justify-between">
				<code class="text-sm font-mono dark:text-white"> ~/voi/bin/goal account partkeyinfo </code>
				<button
					class="ml-2 p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
	...
	<div class="space-y-3">
		...
		<p class="text-gray-600 dark:text-gray-400">
			Copy the entire key information block that appears after running the command above. The block
			will contain details like Participation ID, Parent address, and various keys. Use the "Paste
			All from Clipboard" button to paste this information into the form below.
		</p>
		<div
			class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700"
		>
