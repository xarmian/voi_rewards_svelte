...
<div class="min-h-full">
	<div class="n27 flex flex-col pt-4 relative">
		{#if project}
			<div class="sm:mx-4">
				<Project {project} bind:searchWallet wallet={selectedWallet ?? null} />
			</div>
		{/if}
	</div>
	<div class="n27 pb-8 text-center">
		<p class="text-gray-500">
			Reached the end? Check out the <a href="/phase2" class="text-blue-500 hover:text-blue-700"
				>full list of projects</a
			> to find more quests, and check back regularly for new quests and updates.
		</p>
	</div>
</div>
