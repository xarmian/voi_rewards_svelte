...
<div class="restofpage">
    <div class="p-4 sm:px-12 text-black flex-col flex sm:flex-row justify-evenly items-center">
        <div class="project flex flex-row justify-between shadow-2xl shadow-black bg-[#65DBAB] border border-black p-6 sm:w-[30rem] rounded-2xl space-x-2 z-10 mb-6 sm:mb-0">
    ...
    <div class={`p-4 md:p-20 text-black flex justify-between items-center min-h-72 md:h-72 flex-row-reverse`}>
        <Saos once={true} animation={`${!isMobile ? 'from-right' : ''} 0.5s cubic-bezier(0.35, 0.5, 0.65, 0.95) both`}>
            <div class="project flex flex-row justify-between shadow-2xl shadow-black bg-[#65DBAB] border border-black p-6 sm:w-[30rem] rounded-2xl space-x-2 z-10">
                <div class='flex flex-col max-w-screen-sm h-full'>
                    ...
                    <Saos once={true} animation={`fadein 2s cubic-bezier(0.35, 0.5, 0.65, 0.95) both; height: 100%; align-content: center;`}>
                        <div class={`flex flex-col justify-center space-y-4`}>
                            <a href='https://app.galxe.com/quest/87cpJsQTTj3A9XnXam47tQ/GCB1StzTo8' target="_blank" class="bg-white text-[#672ed9] font-bold py-2 px-4 rounded-lg shadow-md hover:bg-[#672ed9] hover:text-white">Social Quests</a>
                        </div>
                    </Saos>
                </div>
        </Saos>
