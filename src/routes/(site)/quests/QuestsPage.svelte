...
<div class="p-4 sm:px-12 text-white flex flex-row justify-evenly items-center bg-blue-300">
    <div class="flex flex-row justify-between shadow-2xl shadow-black bg-purple-400 border border-black p-6 sm:w-[30rem] rounded-2xl space-x-2 z-10">
        ...
        <div class={`flex flex-col justify-center space-y-4`}>
            <a href='https://kibis.is/' target="_blank" class="bg-white text-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-500 hover:text-white">Wallet</a>
            <a href='https://voiager.org/get-started' target="_blank" class="bg-white text-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-500 hover:text-white">Faucet</a>
            <a href='https://airtable.com/apphFYuejZFJJG0i6/shru2v6BXxUaAEU7O' target="_blank" class="bg-white text-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-500 hover:text-white">Ecosystem Directory</a>
            <a href='https://medium.com/@rob.sanders1/a-voiagers-guide-to-node-running-a0251194a64a' target="_blank" class="bg-white text-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-500 hover:text-white">Node Running</a>
        </div>
    </div>
...
<div class={`p-4 md:p-20 text-white flex justify-between items-center min-h-72 md:h-72 bg-blue-300 flex-row-reverse`}>
        ...
        <div class="flex flex-row justify-between shadow-2xl shadow-black bg-purple-400 border border-black p-6 sm:w-[30rem] rounded-2xl space-x-2 z-10">
            <div class='flex flex-col max-w-screen-sm h-full'>
                ...
                <Saos once={true} animation={`fadein 2s cubic-bezier(0.35, 0.5, 0.65, 0.95) both; height: 100%; align-content: center;`}>
                    <div class={`flex flex-col justify-center space-y-4`}>
                        <a href='https://app.galxe.com/quest/87cpJsQTTj3A9XnXam47tQ/GCB1StzTo8' target="_blank" class="bg-white text-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-500 hover:text-white">Social Quests</a>
                    </div>
                </Saos>
            </div>
    </Saos>
