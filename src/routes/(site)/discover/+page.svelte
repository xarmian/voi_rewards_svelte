...
<div class="space-y-6">
	...
	<header
		class="bg-gradient-to-r from-purple-700 to-indigo-800 text-white p-6 rounded-xl shadow-md"
	>
	...
	<div class="overflow-x-auto whitespace-nowrap pb-3 hide-scrollbar">
		<div class="inline-flex space-x-3 px-1">
			<button
				class="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 backdrop-blur-sm border shadow-sm {$currentCategory ===
				undefined
