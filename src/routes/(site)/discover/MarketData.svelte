...
<div class="flex flex-col sm:flex-row items-center gap-3 justify-center w-full max-w-md">
	...
	{:else if error}
		<div class="text-sm text-red-300 bg-red-500/20 px-4 py-2 rounded-xl">
			Unable to load market data
		</div>
	{:else if marketData}
		<div class="flex gap-4 items-center justify-center w-full">
			<div
				class="flex-1 backdrop-blur-sm bg-white/10 px-4 py-2 rounded-xl border border-white/20 shadow-sm"
			>
