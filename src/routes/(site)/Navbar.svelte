...
<Navbar fluid={true}>
  <NavBrand href="https://voirewards.com" class="float-left">
    <img src="{Icon}" class="mr-3 h-10 sm:h-20" alt="Logo" />
    <div class="nav-title whitespace-nowrap text-xl font-semibold dark:text-white">Voi Rewards Auditor</div>
  </NavBrand>
  ...
  <NavUl>
    ...
    <NavLi class="text-xl" href="/quests"><div class:selected={activeLink === '/phase2'} on:click={() => activeLink = '/quests'} transition:fly={{ y: 50, duration: 400 }}>Quests</div></NavLi>
