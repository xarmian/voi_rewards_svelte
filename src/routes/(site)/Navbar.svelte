...
<Navbar
	fluid={true}
	class="bg-gradient-to-r from-white to-gray-50 dark:from-slate-900 dark:to-slate-800 text-gray-700 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700/50 shadow-sm"
>
	<NavBrand href="https://voirewards.com" class="float-left">
		...
		<div
			class="nav-title whitespace-nowrap text-xl sm:text-2xl font-semibold text-gray-800 dark:text-white"
		>
			Voi Rewards Auditor
		</div>
	</NavBrand>
	...
	<div class="hidden sm:flex flex-row items-center ml-auto gap-2 mr-4">
		...
		<div class="relative flex items-center gap-2">
			<button
				id="avatar-menu"
				class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-white hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors rounded-full"
...
{#if isMenuOpen}
	...
	>
		<!-- Swipe hint -->
		<div
			class="text-gray-400 dark:text-white/50 text-sm text-center py-2 border-b border-gray-200 dark:border-slate-700"
		>
		...
		<div class="flex-1 overflow-y-auto">
			<div class="flex flex-col p-4 space-y-4">
				...
				<div class="border-t border-gray-200 dark:border-slate-700 pt-4 mt-4">
					<div class="text-gray-500 dark:text-white/70 text-sm font-medium px-4 mb-2">
						Resources
					</div>
					{#each resourceItems as item}
						<a
