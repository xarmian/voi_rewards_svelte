	...
	<div class="container mx-auto p-4 max-w-3xl">
		...
		<div class="hidden">
			<div class="bg-white rounded-lg shadow-md p-6 mb-6 dark:bg-gray-800">
				Use of this site requires connecting a Discord account and one or more Voi wallets. The
				Discord account is used to verify your identity and Voi wallets are used to calculate and
				receive rewards. View the <button
					on:click={() => (showPrivacyModal = true)}
					class="text-blue-500">Privacy Policy</button
				> for more information.
			</div>

			<a
				href="https://discord.com/channels/1055863853633785857/1278379464019152998"
				target="_blank"
			...
			>
				<div class="text-xl font-semibold">Get the most from your Phase 2 Airdrop</div>
				<div class="text-sm">After connecting your Discord account</div>
				<div class="flex text-2xl underline self-center items-center">
					Complete Human Verification!
					<InfoButton noAbsolute={true}>
						<div class="text-xs">
							While Human verification is not required to receive the Phase 2 Airdrop, doing so will
							provide a boost to your rewards.
						</div>
					</InfoButton>
				</div>
			</a>
			...
			<div class="bg-white rounded-lg shadow-md p-6 mb-6 dark:bg-gray-800">
				...
				{:else}
					...
					<div class="text-sm">
						NOTE: Your Discord account E-Mail address must be verified with Discord for this
						connection to work.
					</div>
				{/if}
				{#if discordAccounts.length > 0}
					<div class="m-4 flex items-center justify-center">
						<label class="flex items-center space-x-2 cursor-pointer">
							...
							<span class="text-gray-700 dark:text-gray-300"
								>Opt in to receive Voi Notification E-mails</span
							>
						</label>
					</div>
					{#if !isOptedIn}
						<div class="text-red-500 text-center">
							You are opted out of receiving Notification E-Mails.
						</div>
					{/if}
				{/if}
			</div>
			...
			<div
				class="flex flex-col bg-white rounded-lg shadow-md p-6 dark:bg-gray-800 {discordAccounts.length ===
				0
			...
			>
				...
				<div class="text-gray-600 dark:text-gray-400 mb-4">
					Connect your Voi addresses here. Your accounts will be aggregated, and any rewards will be
					sent to the wallet designated as Primary.
				</div>
							...
							>
								...
								{#if wallet.is_primary}
									<span class="flex">
										...
										<InfoButton noAbsolute={true}>
											<div class="text-xs">
												This wallet is set as your primary wallet. You can only have one primary
												wallet at a time. Your primary wallet will be used to receive rewards.
											</div>
										</InfoButton>
									</span>
								{:else}
									<span
										class="hidden text-blue-500 cursor-pointer"
										on:click={() => setPrimary(wallet.address)}
									>
		...
		<div class="bg-white rounded-lg shadow-md p-6 dark:bg-gray-800 max-w-3xl">
			...
			<div class="overflow-auto" style="height: 75vh;">
				...
				<div class="privacy-policy p-6 rounded-lg shadow-md">
					...
					<p class="mb-4">
						Welcome to Voirewards.com ("we," "our," or "us"). This Privacy Policy explains how we
						collect, use, disclose, and safeguard your information when you use our website and
						services, particularly in relation to connecting your Discord account and Voi wallet for
						participation in rewards distributions conducted by the Voi Foundation.
					</p>
					<p class="mb-4">
						While Voirewards.com is not directly affiliated with the Voi Foundation, data submitted
						to this website may be collected and shared with the Voi Foundation for these stated
						purposes.
					</p>
					...
					<ul class="list-disc list-inside mb-4">
						...
						<li>
							Service Providers: Third-party vendors who help us operate our website and provide our
							services
						</li>
